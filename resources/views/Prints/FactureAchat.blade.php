...
<head>
    ...
    <title>Facture Achat Nº{{ $commande->numero_Facture }}</title>
...
<body>
    <header>
        <h1><u>Facture Nº::{{ $commande->numero_Facture }}</u></h1>
    </header>
        ...
        <thead>
            <tr>
                ...
                <th width="50%" colspan="3" class="text-start company-data">
                    ...
                    <br>
                    <span><strong>Nº Bon de Livraison : </strong> <u> Nº{{ $commande->Numero_bonLivraison }}</u></span>
                    <br>
    ...
    <footer style="position: absolute;margin-bottom:0.5rem; bottom:0 ;width:100% ; text-align:center">
        ...
        {!! DNS2D::getBarcodeHTML(url('api/printf/' . $commande->id . '/false'), 'QRCODE', 4, 4) !!}
