...
<head>
    ...
    <title>Avoirs Nº{{ $commande->numero_avoirsVente }}</title>
...
<body>
    <header>
        <h1><u>Avoirs Nº::{{ $commande->numero_avoirsVente }}</u></h1>
    </header>
        ...
        <thead>
            <tr>
                ...
                <th width="50%" colspan="3" class="text-start company-data">
                    ...
                    <span><strong>Date Echeance : </strong>{{ $dateFacture->addDays(60)->format('d/m/Y') }}</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
