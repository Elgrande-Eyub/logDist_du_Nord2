...
<head>
    ...
    <title>Bon Reception de BL Nº{{ $commande->Numero_bonLivraisonVente }}</title>
...
<body>
    <header>
        <h1><u>Bon Reception de Nº::{{ $commande->Numero_bonLivraisonVente }}</u></h1>
    </header>
        ...
        <thead>
            <tr>
                ...
                <th width="60%" colspan="1" class="text-start company-data">
                    ...
                    <br>
                    <span><strong>Nº Bon de Livriason:</strong> <u> Nº{{ $commande->Numero_bonLivraisonVente }}</u></span>
                    <br>
